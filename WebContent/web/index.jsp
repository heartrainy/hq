...
<body ms-controller="index">
	<input type="hidden" id="base_url"ri value="${pageContext.request.contextPath}" />
	        ...
	        <!-- <ul ms-with="treeList"> -->
	            ...
	            <li class="submenu"> 
	                ...
	                <ul>
	                    ...
	                    <li><a class="menu_a" link="sub/base/warehouseArea.html" stitle="库区管理" tid="5"><i class="icon icon-caret-right"></i>库区管理</a></li>
	                </ul>
	            </li>
	            <li class="submenu">
					<a href="#">
